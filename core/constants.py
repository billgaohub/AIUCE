...
# ─── Layer Identifiers ──────────────────────────────────────────
class Layer:
    L0_WILL       = "L0"   # 意志层 - 秦始皇/御书房
    L1_IDENTITY   = "L1"   # 身份层 - 诸葛亮/宗人府
    L2_PERCEPTION = "L2"   # 感知层 - 魏征/都察院
    L3_REASONING  = "L3"   # 推理层 - 张良/军机处
    L4_MEMORY     = "L4"   # 记忆层 - 司马迁/翰林院
    L5_DECISION   = "L5"   # 决策层 - 包拯/大理寺
    L6_EXPERIENCE = "L6"   # 经验层 - 曾国藩/吏部
    L7_EVOLUTION  = "L7"   # 演化层 - 商鞅/中书省
    L8_INTERFACE  = "L8"   # 接口层 - 张骞/礼部
    L9_AGENT      = "L9"   # 代理层 - 韩信/锦衣卫
    L10_SANDBOX   = "L10"  # 沙盒层 - 庄子/钦天监
